...
public abstract class StreamingBaseActivity extends Activity
        implements StreamingSessionListener, StreamStatusCallback, StreamingStateChangedListener, AudioSourceCallback {
    ...
    public void onStateChanged(StreamingState streamingState, Object extra) {
        ...
        switch (streamingState) {
            ...
            case IOERROR:
                /**
                 * Network-connection is unavailable when `startStreaming`. You can
                 * `startStreaming` later or just finish the streaming
                 */
                mLogContent += "IOERROR\n";
                mStatusMsgContent = getString(R.string.string_state_ready);
                setShutterButtonEnabled(true);
            ...
            case DISCONNECTED:
                /**
                 * Network-connection is broken when streaming You can do reconnecting in
    ...
    public boolean onRestartStreamingHandled(int code) {
        /**
         * When the network-connection is broken, StreamingState#DISCONNECTED will
         * notified first, and then invoked this method if the environment of restart
         * streaming is ready.
         *
         * @return true means you handled the event; otherwise, given up and then
         *         StreamingState#SHUTDOWN will be notified.
         */
    ...
    private void initEncodingProfile() {
        ...
        mProfile.setDnsManager(getMyDnsManager()).setStreamStatusConfig(new StreamingProfile.StreamStatusConfig(3))
                .setSendingBufferProfile(new StreamingProfile.SendingBufferProfile(0.2f, 0.8f, 3.0f, 20 * 1000));
    }

    /**
     * If you want to use a custom DNS server, config it Not required.
     */
