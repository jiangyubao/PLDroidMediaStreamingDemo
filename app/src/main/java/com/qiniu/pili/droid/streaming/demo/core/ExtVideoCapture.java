...
public final class ExtVideoCapture implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    public interface OnPreviewFrameCallback {
        void onPreviewFrameCaptured(byte[] data, int width, int height, int orientation, boolean mirror, int fmt,
                long tsInNanoTime);
    }
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
        ...
        if (mOnPreviewFrameCallback != null) {
            mOnPreviewFrameCallback.onPreviewFrameCaptured(data, mPreviewWidth, mPreviewHeight, mCameraPreviewDegree,
                    false, PLFourCC.FOURCC_NV21, System.nanoTime());
        }
