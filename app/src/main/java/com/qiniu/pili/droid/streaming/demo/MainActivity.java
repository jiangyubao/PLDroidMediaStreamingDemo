...
public class MainActivity extends FragmentActivity {
    ...
    private static final Class[] ACTIVITY_CLASSES = { AVStreamingActivity.class, AudioStreamingActivity.class,
            ImportStreamingActivity.class, ScreenStreamingActivity.class };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEncodingConfigFragment = (EncodingConfigFragment) fragmentManager
                .findFragmentById(R.id.encoding_config_fragment);
