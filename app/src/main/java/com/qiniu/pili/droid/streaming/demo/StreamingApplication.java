...
public class StreamingApplication extends Application {
    ...
    public void onCreate() {
        ...
        /**
         * track app background state to avoid possibly stopping microphone recording in
         * screen streaming mode on Android P+
         */
     ...
     *
     * on Android P+, it doesn't allow recording audio to protect user's privacy in
     * idle state.
     */
